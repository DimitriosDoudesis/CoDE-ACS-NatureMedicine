...
Threshold_table_rule_out_no_round <- function(data, model_preds, folder) {
  ...
  # New addition
  thresholds <- seq(0.005,0.20, 0.001)
  ...
  write_rds(df_metrics,
          glue::glue("{folder}/{model_preds}_thresholds_table_NO_round"))
  
} # end of function



Threshold_table_rule_out <- function(data, model_preds, folder) {
